  ...
  async function main() {
      ...
      deviceIot.on('message', function(_topic, payload) {
          ...
          if (command == "location") {
            ...
            if (odom) {
              ...
              vue.ODOM_GOAL_INFO =  odom["status"];
            }
          }
      ...
      methods: {
        ...
        move_off: function () {console.log("cmd_vell_off"); move_action = "offmode"; syncJob()},
        map_save: function () {
          let payload = {};
        ...
        go_to_nextgoal: function() {
          console.log("go to nextgoal!!");
          let payload = {};
          request_id =  (new Date()).getTime();
          payload["goal_control_key"] = "goto";
