...
{   
    ...
    initPose.pose.pose.position.x = 0.091920;
    initPose.pose.pose.position.y = 0.164464;
    initPose.pose.pose.position.z  = 0;
    initPose.pose.pose.orientation.z = 0.9489846194;
    initPose.pose.pose.orientation.w = 0.3153223624;


    vector<vector<string>> waypoint_read = 
    {
        {"-0.807409","0.201128","0.961762","0.273885","goal"},
        {"-1.555681","0.707262","0.939273","0.343170"},
        {"-2.235975","1.260302","0.943885","0.330274","goal"}
